...
app_cli_status_e cli__task_orientation(app_cli__argument_t argument, sl_string_t user_input_minus_command_name,
                                       app_cli__print_string_function cli_output) {
  ...
  if (sl_string__begins_with_ignore_case(s, "off")) {
  ...
  } else if (sl_string__begins_with_ignore_case(s, "on")) {
    sl_string__erase_first_word(s, ' ');
