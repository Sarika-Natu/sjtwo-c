...
void sj2_cli__init(void) {
  ...
  static app_cli__command_s task_ctrl = {.command_name = "taskcontrol",
                                         .help_message_for_command = "taskcontrol suspend <task name>\n"
                                                                     "taskcontrol resume <task name>\n",
                                         .app_cli_handler = cli__task_ctrl};
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &task_ctrl);
